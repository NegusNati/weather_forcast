...
Widget midview(AsyncSnapshot snapshot) {
  ...
  var formatedDate = Util.getFormatedDate(
    DateTime.fromMillisecondsSinceEpoch(forecastList[0].dt * 1000),
  ); // multiply by 1000 to get the current millisecond
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      children: [
                        Text("${forecastList[0].speed.toStringAsFixed(0)} M/s ",
                    ...
                    Column(
                      children: [
                        Text("${forecastList[0].humidity}% ",
                            style: kSmallTextStyle),
                        const SizedBox(height: 5),
                        const Icon(FontAwesomeIcons.faceGrinBeamSweat,
                            size: 20, color: Colors.brown)
                      ],
                    ),
                    Column(
